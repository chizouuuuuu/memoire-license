...
--
-- Client :  127.0.0.1
-- Généré le :  Sam 31 Mai 2025 à 01:20
...
INSERT INTO `etudiant` (`id_etudiant`, `niveau_etude`, `date_inscription`, `platforme`) VALUES
(101, '3e année médecine', '2024-09-20', 'OphtaLearning'),
(102, 'Internat médecine', '2024-10-05', 'OphtaLearning');
...
INSERT INTO `professeur` (`id_utilisateur`, `specialite`, `grade_academique`, `date_embauche`) VALUES
(1, 'Ophtalmologie', 'Professeur', '2015-09-01'),
(2, 'Ophtalmologie', 'Maître de conférences', '2018-03-15');
